...
<body style="padding-top:70px;">
    <div class="container">
                ...
                <tbody>
                    <?php
                        ...
                        foreach($staffData as $staff) {
                            ...
                            echo '<td><a class="btn btn-primary" href ="./root_staff.php?code='.$staff['code'].'">詳細</a></td>';
                            echo '</tr>';
                        }
                    ?>
                </tbody>
        ...
        <a href="./root_staff.php?code=0" class="btn btn-primary">スタッフ追加</a>
        <a href="./root_top.php">トップページ</a>
    </div>
