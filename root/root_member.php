                        ...
                        <div class="col-12 border">
                            <form method="post" action="shop_mypage.php">
                                <?php
                                    // include './session.php';
                                    $member = new DB();
                                    $memberData = $member->getMemberOnly($_GET['id']);
                                ?>
                                <br>
                                お名前 <br>
                                <input class="form-control" type="text" name="name" value="<?php echo $memberData[0]['name'];?>">
                                <?php if(isset($error['name']) && ($error['name']) == true) echo $validation::ERROR_STR01;?>
                                <br>
                                メールアドレス<br>
                                <input class="form-control" type="text" name="email" value="<?php echo $memberData[0]['email'];?>">
                                <?php if(isset($error['mail']) && ($error['mail']) == true) echo $validation::ERROR_STR02;?>
                                <br>
                                郵便番号<br>
                                <input class="form-control" type="text" name="postal" placeholder="000-0000" value="<?php echo $memberData[0]['postal'];?>">
                                <?php if(isset($error['postal']) && ($error['postal']) == true) echo $validation::ERROR_STR04;?>
                                <br>
                                住所<br>
                                <input class="form-control" type="text" name="address" value="<?php echo $memberData[0]['address'];?>">
                                <?php if(isset($error['address']) && ($error['address']) == true) echo $validation::ERROR_STR03;?>
                                <br>
                                電話番号<br>
                                <input class="form-control" type="text" name="tel" value="<?php echo $memberData[0]['tel'];?>">
                                <?php if(isset($error['tel']) && ($error['tel']) == true) echo $validation::ERROR_STR05;?>
                                <br>
                                パスワード<br>
                                <input class="form-control" type="password" name="password" value="<?php echo $memberData[0]['password'];?>">
                                ...
                                <div class="text-center">
                                    ...
                                    <a href="delete_member.php?id=" class="btn btn-danger">削除する</a>
                                </div>
                                <br>
                            </form>
                        </div>
