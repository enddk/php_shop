                ...
                <div class="container">
                    <div class="row">
                        <?php
                            ...
                            {
                                echo '<div class="col-12 col-md-4 border">';
                                echo '<div class="card">';
                                echo '<img src="../../product/gazou/'.$productData[$i]['gazou'].'" alt="" class="card-img-top" style="width:100%; height:250px;">';
                                echo '<div class="card-body">';
                                echo '<h4 class="card-title">'.$productData[$i]['name'].'</h4>';
                                echo '<h6 class="card-subtitle">'.$productData[$i]['price'].' 円</h6>';
